...
public class ApplicationExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> handleValidationExceptions(
    ...
    ProblemDetail problemDetail =
        buildProblemDetail("Validation Error", HttpStatus.BAD_REQUEST, "Validation failed");
  ...
  public ResponseEntity<ProblemDetail> handleUserNotFoundException(NotFoundException ex) {
    ...
    ProblemDetail problemDetail =
        buildProblemDetail("User not found exception", HttpStatus.NOT_FOUND, ex.getMessage());
  ...
  public ResponseEntity<ProblemDetail> handleClientException(ClientException ex) {
    ...
    ProblemDetail problemDetail =
        buildProblemDetail(
            "Unexpected client exception", HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage());
    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(problemDetail);
  }

  private ProblemDetail buildProblemDetail(String title, HttpStatus status, String detail) {
