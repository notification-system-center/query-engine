...
public class UserMapper {
  ...
  public static UserDetail toDto(UserEntity entity) {
    ...
    dto.setLanguage(
        entity.getLanguage() != null ? Language.valueOf(entity.getLanguage().name()) : null);
    dto.setAccountStatus(
        entity.getAccountStatus() != null
            ? AccountStatus.valueOf(entity.getAccountStatus().name())
            : null);
  ...
  public static UserEntity toEntity(UserDetail dto) {
    ...
    entity.setGender(
        dto.getGender() != null ? UserEntity.Gender.valueOf(dto.getGender().name()) : null);
    entity.setLanguage(
        dto.getLanguage() != null ? UserEntity.Language.valueOf(dto.getLanguage().name()) : null);
    entity.setAccountStatus(
        dto.getAccountStatus() != null
            ? UserEntity.AccountStatus.valueOf(dto.getAccountStatus().name())
            : null);
